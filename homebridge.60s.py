#!/usr/bin/env python
# -*- coding: utf-8 -*-
# <bitbar.title>HomeBridge status</bitbar.title>
# <bitbar.version>v1</bitbar.version>
# <bitbar.author>Dave Smythe</bitbar.author>
# <bitbar.author.github>C4Wiz</bitbar.author.github>
# <bitbar.desc></bitbar.desc>
# <bitbar.image></bitbar.image>
# <bitbar.dependencies>homebridge,python</bitbar.dependencies>

# URL to the Homebridge UI
base_url = "http://homebridge.local"
...
print "Homebridge Stats | color=silver"
separator()
...
# gets Homebridge versions
 ...
 #print("Update available: %s" % homebridge_core['latest']) + "| color=red"
#else:
 #print("Up to date| color=green")
separator()
#if homebridge_control4['current'] != homebridge_control4['latest']:
 #print("Update available: %s" % homebridge_control4['latest']) + "| color=red"
#else:
 #print("Up to date| color=green")
separator()
#if homebridge_appliance['current'] != homebridge_appliance['latest']:
